...
`,this}addMutation(r,s,e){return this.setRootType("mutation").addFieldWithArgs(r,s),e.forEach(n=>this.addField(n)),this.close(),this}};export{l as a,u as b,p as c};
